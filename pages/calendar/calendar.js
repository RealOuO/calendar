...
Page({
  ...
  getSchedule: function getSchedule(year, month){
    ...
    smonth = year + '-' + smonth;
    var members = wx.getStorageSync(smonth) || [];
  ...
  initCurDate: function initCurDate(year, month, day) {
    ...
    pageData.main = [];
    for(var member of pageData2.members){
      if(member[0]=='方晓丹'){
        pageData.main = member;
      }
    }
